                    ...
                    if (!dataSnapshot.exists()) {
                        ...
                        databaseReference1ToCurrentUser.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                matchEducation=myUsersDataModel.getMatchEducation();
                                ...
                                databaseReferenceToAllUsers.addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                        ...
                                        for( DataSnapshot snapshot: dataSnapshot.getChildren()){
                                            ...
                                            if(usersDataModel.getMyEducation()!=null && usersDataModel.getUserGender()!=null
                                            && !BMHelper.isNullOrEmpthy(usersDataModel.getUserAge())  && matchCity!=null && matchEducation!=null && matchFromAge!=0 && matchToAge!=0 && matchGender!=null){
