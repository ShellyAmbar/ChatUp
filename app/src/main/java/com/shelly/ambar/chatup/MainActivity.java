...
import com.shelly.ambar.chatup.Customs.CurvedView;
...
public class MainActivity extends AppCompatActivity
    ...
    private CurvedView curvedIndicator;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle(" ");
        shake = AnimationUtils.loadAnimation(MainActivity.this, R.anim.shake_sides);

        curvedIndicator = findViewById(R.id.curvedIndicator);
        curvedIndicator.setNumOfSections(5,this);
        ...
        Bundle intent=getIntent().getExtras();
            ...
            if(intent!=null) {
                ...
                if(intent.getString("keySearch")!=null){
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
            switch (menuItem.getItemId()){
                case R.id.nav_home:
                    ...
                    curvedIndicator.animate().translationX(0).start();
                    curvedIndicator.setAnimation(shake);
                    break;
                case R.id.nav_add:
                    SelectedFragment=null;
                    Intent intent=new Intent(MainActivity.this,FilterActivity.class);
                    intent.putExtra("Activity","Post");
                    curvedIndicator.animate().translationX(curvedIndicator.getWidth()*2).start();
                    curvedIndicator.setAnimation(shake);
                ...
                case R.id.nav_like:
                    ...
                    curvedIndicator.animate().translationX(curvedIndicator.getWidth()*4).start();
                    curvedIndicator.setAnimation(shake);
                    break;
                ...
                case R.id.nav_profile:
                    ...
                    curvedIndicator.animate().translationX(curvedIndicator.getWidth()*3).start();
                    curvedIndicator.setAnimation(shake);
                    break;
                case R.id.nav_search:
                    SelectedFragment=new SearchFragment();
                    curvedIndicator.animate().translationX(curvedIndicator.getWidth()).start();
                    curvedIndicator.setAnimation(shake);
                    break;
            }
